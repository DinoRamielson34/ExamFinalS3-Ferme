...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="index.html" class="navbar-brand ms-lg-5">
            <h1 class="m-0 text-uppercase text-dark"><i class="bi bi-shop fs-1 text-primary me-3"></i>Star Breeders</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="<?php echo $base_url ?>/product" class="nav-item nav-link">Alimentation</a>
                <a href="<?php echo $base_url ?>/" class="nav-item nav-link">Se déconecter</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Admin</a>
                    <div class="dropdown-menu m-0">
                        <a href="<?php echo $base_url ?>/liste" class="dropdown-item">Animaux</a>
                        <a href="<?php echo $base_url ?>/alimentation" class="dropdown-item">Alimentation</a>
                    </div>
                </div>
                <a href="<?php echo $base_url ?>/tableau"
                    class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Tableau
                    de bord
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white" href="#">Star Breeders</a>. All Rights Reserved.
                    </p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-white" href="https://htmlcodex.com">Miojoro & Dino & Ny
                            Voary</a></p>
                </div>
            </div>
        </div>
